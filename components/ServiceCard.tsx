    ...
    <Link href={href} className="group block rounded-[26px] border border-slate-200 bg-white p-5 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:shadow-card">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div className="rounded-full bg-navy px-2 py-1 text-[10px] font-bold tracking-[0.18em] text-white">
            {number}
          </div>
        </div>
        <div className="flex h-9 w-9 items-center justify-center rounded-full bg-slate-100 text-lg text-navy transition-transform duration-200 group-hover:translate-x-1">
          →
        </div>
      </div>
